                  ...
                  GestureDetector(
                    onTap: () {
                      if(formtime == "") {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Center(child: Text('Please Enter Valid Mobile Number')), behavior: SnackBarBehavior.floating, duration: Duration(seconds: 2),));
                      } else {
